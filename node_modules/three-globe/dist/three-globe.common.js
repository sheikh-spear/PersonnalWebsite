...
var _bfg = require('three/examples/jsm/utils/BufferGeometryUtils.js');
...
var threeFatline = require('three-fatline');
...
var _bfg__namespace = /*#__PURE__*/_interopNamespace(_bfg);
...
var GlobeLayerKapsule = Kapsule__default['default']({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE$a.LineSegments(new threeGeojsonGeometry.GeoJsonGeometry(d3Geo.geoGraticule10(), GLOBE_RADIUS, 2), new THREE$a.LineBasicMaterial({
      color: 'lightgrey',
      transparent: true,
      opacity: 0.1
    }));
  ...
  update: function update(state, changedProps) {
    ...
    if (changedProps.hasOwnProperty('globeImageUrl')) {
      if (!state.globeImageUrl) {
        ...
        !globeMaterial.color && (globeMaterial.color = new THREE$a.Color(0x000000));
      } else {
...
var bfg$2 = Object.assign({}, _bfg__namespace);
...
var PointsLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    var scene = state.pointsMerge ? new THREE$9.Object3D() : state.scene; // use fake scene if merging points
    ...
    if (state.pointsMerge) {
      ...
      var pointsGeometry = !state.pointsData.length ? new THREE$9.BufferGeometry() : BufferGeometryUtils$2.mergeBufferGeometries(state.pointsData.map(function (d) {
        ...
        var color = new THREE$9.Color(colorAccessor(d));
    ...
    function updateObj(obj, d) {
      var applyUpdate = function applyUpdate(td) {
        ...
        var globeCenter = state.pointsMerge ? new THREE$9.Vector3(0, 0, 0) : state.scene.localToWorld(new THREE$9.Vector3(0, 0, 0)); // translate from local to world coords
      ...
      if (!state.pointsMerge) {
        ...
        if (!pointMaterials.hasOwnProperty(color)) {
          pointMaterials[color] = new THREE$9.MeshLambertMaterial({
...
var ArcsLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    var sharedMaterial = new THREE$8.ShaderMaterial(_objectSpread2(_objectSpread2({}, gradientShaders$1), {}, {
      transparent: true,
      ...
      updateObj: function updateObj(group, arc) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          if (useTube) {
            ...
            obj.geometry = new THREE$8.TubeBufferGeometry(curve, state.arcCurveResolution, stroke / 2, state.arcCircularResolution);
            obj.geometry[setAttributeFn$1]('vertexColor', vertexColorArray);
            obj.geometry[setAttributeFn$1]('vertexRelDistance', vertexRelDistanceArray);
          } else {
    ...
    function calcCurve(_ref) {
      ...
      var altitude = alt;
      (altitude === null || altitude === undefined) && (altitude = d3Geo.geoDistance(startPnt, endPnt) / 2 * altAutoScale);
      ...
      if (altitude) {
        ...
        var curve = _construct(THREE$8.CubicBezierCurve3, _toConsumableArray([startPnt, m1Pnt, m2Pnt, endPnt].map(getVec))); //const mPnt = [...interpolate(0.5), altitude * 2];
      ...
      function calcSphereArc(startVec, endVec) {
        ...
        var getGreatCirclePoint = function getGreatCirclePoint(t) {
          return new THREE$8.Vector3().addVectors(startVec.clone().multiplyScalar(Math.sin((1 - t) * angle)), endVec.clone().multiplyScalar(Math.sin(t * angle))).divideScalar(Math.sin(angle));
        };
...
var bfg$1 = Object.assign({}, _bfg__namespace);
...
var HexBinLayerKapsule = Kapsule__default['default']({
  props: {
    hexBinPointsData: {
      "default": []
    },
  ...
  update: function update(state) {
    // Accessors
    var latAccessor = accessorFn__default['default'](state.hexBinPointLat);
    var lngAccessor = accessorFn__default['default'](state.hexBinPointLng);
    var weightAccessor = accessorFn__default['default'](state.hexBinPointWeight);
    var altitudeAccessor = accessorFn__default['default'](state.hexAltitude);
    var topColorAccessor = accessorFn__default['default'](state.hexTopColor);
    var sideColorAccessor = accessorFn__default['default'](state.hexSideColor);
    var marginAccessor = accessorFn__default['default'](state.hexMargin);
    var byH3Idx = indexBy__default['default'](state.hexBinPointsData.map(function (d) {
    ...
    var scene = state.hexBinMerge ? new THREE$7.Object3D() : state.scene; // use fake scene if merging hex points
    ...
    if (state.hexBinMerge) {
      // merge points into a single mesh
      var hexPointsGeometry = !hexBins.length ? new THREE$7.BufferGeometry() : BufferGeometryUtils$1.mergeBufferGeometries(hexBins.map(function (d) {
        var obj = d.__threeObj;
        d.__threeObj = undefined; // unbind merged points
    ...
    function createObj(d) {
      ...
      obj.__hexGeoJson = h3Js.h3ToGeoBoundary(d.h3Idx, true).reverse(); // correct polygon winding
    ...
    function updateObj(obj, d) {
      ...
      obj.geometry = new threeConicPolygonGeometry.ConicPolygonBufferGeometry([geoJson], 0, GLOBE_RADIUS, false, true, true, topCurvatureResolution);
      var targetD = {
        alt: +altitudeAccessor(d)
      };
      ...
      if (Object.keys(targetD).some(function (k) {
        ...
        if (state.hexBinMerge || !state.hexTransitionDuration || state.hexTransitionDuration < 0) {
          ...
          // animate
          new TWEEN__default['default'].Tween(currentTargetD).to(targetD, state.hexTransitionDuration).easing(TWEEN__default['default'].Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
        }
      }
      ...
      if (!state.hexBinMerge) {
        ...
        [sideColor, topColor].forEach(function (color) {
          if (!hexMaterials.hasOwnProperty(color)) {
            var opacity = colorAlpha(color);
            hexMaterials[color] = new THREE$7.MeshLambertMaterial({
              color: colorStr2Hex(color),
              transparent: opacity < 1,
              opacity: opacity,
              side: THREE$7.DoubleSide
...
var PolygonsLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    var capMaterialAccessor = accessorFn__default['default'](state.polygonCapMaterial);
    var sideColorAccessor = accessorFn__default['default'](state.polygonSideColor);
    var sideMaterialAccessor = accessorFn__default['default'](state.polygonSideMaterial);
    ...
    threeDigest(singlePolygons, state.scene, {
      ...
      createObj: function createObj() {
        ...
        obj.add(new THREE$6.Mesh(undefined, [obj.__defaultSideMaterial, // side material
      ...
      updateObj: function updateObj(obj, _ref) {
        ...
        }) && (conicObj.geometry = new threeConicPolygonGeometry.ConicPolygonBufferGeometry(coords, 0, GLOBE_RADIUS, false, true, true, capCurvatureResolution));
        addStroke && (!strokeObj.geometry.parameters || strokeObj.geometry.parameters.geoJson.coordinates !== coords || strokeObj.geometry.parameters.resolution !== capCurvatureResolution) && (strokeObj.geometry = new threeGeojsonGeometry.GeoJsonGeometry({
          type: 'Polygon',
          coordinates: coords
...
var bfg = Object.assign({}, _bfg__namespace);
var BufferGeometryUtils = bfg.BufferGeometryUtils || bfg;

var HexedPolygonsLayerKapsule = Kapsule__default['default']({
  props: {
    hexPolygonsData: {
      "default": []
    },
  ...
  update: function update(state) {
    // Accessors
    var geoJsonAccessor = accessorFn__default['default'](state.hexPolygonGeoJsonGeometry);
    var colorAccessor = accessorFn__default['default'](state.hexPolygonColor);
    var altitudeAccessor = accessorFn__default['default'](state.hexPolygonAltitude);
    var resolutionAccessor = accessorFn__default['default'](state.hexPolygonResolution);
    var marginAccessor = accessorFn__default['default'](state.hexPolygonMargin);
    var curvatureResolutionAccessor = accessorFn__default['default'](state.hexPolygonCurvatureResolution);
    threeDigest(state.hexPolygonsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (geoJson.type === 'Polygon') {
          h3Idxs.push.apply(h3Idxs, _toConsumableArray(h3Js.polyfill(geoJson.coordinates, h3Res, true)));
        } else if (geoJson.type === 'MultiPolygon') {
          geoJson.coordinates.forEach(function (coords) {
            return h3Idxs.push.apply(h3Idxs, _toConsumableArray(h3Js.polyfill(coords, h3Res, true)));
          });
        } else {
          console.warn("Unsupported GeoJson geometry type: ".concat(geoJson.type, ". Skipping geometry..."));
        }
        ...
        var hexBins = h3Idxs.map(function (h3Idx) {
          var hexCenter = h3Js.h3ToGeo(h3Idx);
          var hexGeoJson = h3Js.h3ToGeoBoundary(h3Idx, true).reverse(); // correct polygon winding
          // stitch longitudes at the anti-meridian
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          obj.geometry = !hexBins.length ? new THREE$5.BufferGeometry() : BufferGeometryUtils.mergeBufferGeometries(hexBins.map(function (h) {
            ...
            return new threeConicPolygonGeometry.ConicPolygonBufferGeometry([geoJson], GLOBE_RADIUS, GLOBE_RADIUS * (1 + alt), false, true, false, curvatureResolution);
          }));
        };
        ...
        if (Object.keys(targetD).some(function (k) {
          ...
          if (!state.hexPolygonsTransitionDuration || state.hexPolygonsTransitionDuration < 0) {
            ...
            // animate
            new TWEEN__default['default'].Tween(currentTargetD).to(targetD, state.hexPolygonsTransitionDuration).easing(TWEEN__default['default'].Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
          }
        }
      }
    });
...
function interpolateVectors(fromPnts, toPnts) {
  ...
  var interpolator = d3Interpolate.interpolateArray.apply(void 0, _toConsumableArray([fromPnts, toPnts].map(function (pnts) {
...
var PathsLayerKapsule = Kapsule__default['default']({
  props: {
    pathsData: {
      "default": []
    },
  ...
  update: function update(state) {
    // Data accessors
    var pointsAccessor = accessorFn__default['default'](state.pathPoints);
    var pointLatAccessor = accessorFn__default['default'](state.pathPointLat);
    var pointLngAccessor = accessorFn__default['default'](state.pathPointLng);
    var pointAltAccessor = accessorFn__default['default'](state.pathPointAlt);
    var strokeAccessor = accessorFn__default['default'](state.pathStroke);
    var colorAccessor = accessorFn__default['default'](state.pathColor);
    var dashLengthAccessor = accessorFn__default['default'](state.pathDashLength);
    var dashGapAccessor = accessorFn__default['default'](state.pathDashGap);
    var dashInitialGapAccessor = accessorFn__default['default'](state.pathDashInitialGap);
    var dashAnimateTimeAccessor = accessorFn__default['default'](state.pathDashAnimateTime);
    var sharedShaderMaterial = new THREE$3.ShaderMaterial(_objectSpread2(_objectSpread2({}, gradientShaders), {}, {
      transparent: true,
    ...
    threeDigest(state.pathsData, state.scene, {
      ...
      updateObj: function updateObj(group, path) {
        ...
        if (!group.children.length || useFatLine === (group.children[0].type === 'Line')) {
          ...
          var _obj = useFatLine ? new threeFatline.Line2(new threeFatline.LineGeometry(), new threeFatline.LineMaterial()) : new THREE$3.Line(new THREE$3.BufferGeometry(), sharedShaderMaterial.clone() // Separate material instance per object to have dedicated uniforms (but shared shaders)
          );
        ...
        if (Object.keys(targetD).some(function (k) {
          ...
          if (!state.pathTransitionDuration || state.pathTransitionDuration < 0) {
            ...
            // animate
            new TWEEN__default['default'].Tween(currentTargetD).to(targetD, state.pathTransitionDuration).easing(TWEEN__default['default'].Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
          }
        }
      }
    }); //
    ...
    threeDigest(state.tilesData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        var applyPosition = function applyPosition(td) {
          ...
          obj.geometry = new THREE$2.SphereBufferGeometry(GLOBE_RADIUS * (1 + alt), Math.ceil(width / (curvatureResolution || -1)), Math.ceil(height / (curvatureResolution || -1)), deg2Rad(90 - width / 2) + (useGlobeProjection ? rotLng : 0), deg2Rad(width), deg2Rad(90 - height / 2) + (useGlobeProjection ? rotLat : 0), deg2Rad(height));
    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN__default['default'].Tween({
          ...
          k: 1
        }, 600).easing(TWEEN__default['default'].Easing.Quadratic.Out).onUpdate(function (_ref13) {
          var k = _ref13.k;
        ...
        new TWEEN__default['default'].Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN__default['default'].Easing.Quintic.Out).onUpdate(function (_ref14) {
          var rot = _ref14.rot;
